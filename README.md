...
Простий та інтуїтивно зрозумілий менеджер завдань, який працює безпосередньо у вашому браузері. У вебзастосуванні реалізовано можливість добавлення нових завдань та видалення непотрібних, збереження напрацьованого списку завдань при оновленні сторінки, після закриття вкладки або перезавантаження комп'ютера за рахунок його збереження у LocalStorage Цей проєкт створений для демонстрації навичок роботи зі статичними вебтехнологіями.
...
👉 **https://shnekars-barbara.github.io/app-task-list-javascript/**
...
1.  **Клонувати репозиторій app-task-list-javascript.git:**
    ```bash
    git clone https://github.com/shnekars-barbara/app-task-list-javascript.git
    ```
...
---
*Розроблено Романом Ковалевичем як навчальний проєкт.*
