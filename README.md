...
Простий та інтуїтивно зрозумілий менеджер завдань, який працює безпосередньо у вашому браузері. У вебзастосуванні реалізовано можливість добавлення нових завдань та видалення непотрібних. Цей проєкт створений для демонстрації навичок роботи зі статичними вебтехнологіями.
